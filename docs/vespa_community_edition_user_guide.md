...
![](initial_form_page.png)

2、查看价格信息，在表单页面中可以查看不同配置对应的价格。

3、配置付费类型，选择适合的付费模式（如按量付费）：

![](payment_type_config.png)

4、配置资源规格，选择合适的实例类型（如ecs.u1-c1m2.xlarge）并设置符合复杂度要求的实例密码：

![](resource_config.png)

5、配置可用区，选择部署区域和可用区（如cn-hangzhou-b）：

![](zone_config.png)

6、确认所有配置信息无误后，点击"创建实例"按钮提交订单：

![](before_submit_order.png)

7、等待服务实例创建完成，可以在服务详情页监控部署进度：

![](deployment_in_progress.png)

8、当服务实例状态显示为"已部署"时，表示部署成功：

![](final_deployed_status.png)

9、点击公网访问地址使用服务（注意：根据测试报告，公网地址可能存在连接超时问题，建议检查安全组配置或通过私网地址访问）。
